...
router.put("/:id/imagen-principal", upload.single("imagen"), async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
...
router.delete("/:id/imagen-principal", async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
...
router.delete("/:id/imagenes", async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
